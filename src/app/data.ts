...
export const mainModules: Module[] = [
  ...
  },
  {
    ...
    lessons: [
      { id: '1', title: 'Aula 1: Passo a passo da preparação corte e medidas', duration: '8min 32s', videoId: 'GwuhgZ4MIh8' },
      { id: '2', title: 'Aula 2: Teto', duration: '10min 15s', videoId: 'pu-pPsVKq90' },
      { id: '3', title: 'Aula 3: Medir e Cortar', duration: '7min 48s', videoId: 'aNrACgQeEsQ' },
      { id: '4', title: 'Aula 4: Ferramentas', duration: '9min 40s', videoId: 'QSWi7Z4YsQ8' },
      { id: '5', title: 'Aula 5: Fita e Massa', duration: '11min 20s', videoId: 'O8d_MSPLCiw' },
      { id: '6', title: 'Aula 6: Revestimento do Drywall - Parte 1', duration: '12min 05s', videoId: '9awHCmPvZF0' },
      { id: '7', title: 'Aula 7: Revestimento do Drywall - Parte 2', duration: '8min 55s', videoId: 'uCkad7WHbCI' },
      { id: '8', title: 'Aula 8: Camada Final', duration: '9min 10s', videoId: 'fn7qg1Mviog' },
      { id: '9', title: 'Aula 9: Verificação final', duration: '6min 30s', videoId: 'Ewdr-8aZZ74' },
      { id: '10', title: 'Aula 10: Lixamento', duration: '7min 15s', videoId: 'YWjS28gudDY' },
      { id: '11', title: 'Aula 11: Pintura do Drywall', duration: '10min 00s', videoId: 'f29BOCZTyns' },
    ],
    duration: '11 aulas',
